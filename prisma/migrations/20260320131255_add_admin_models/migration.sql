...
-- CreateEnum
CREATE TYPE "ProjectStatus" AS ENUM ('PUBLISHED', 'DRAFT', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "SubmissionStatus" AS ENUM ('NEW', 'READ', 'DONE');

-- CreateEnum
CREATE TYPE "SubscriptionStatus" AS ENUM ('ACTIVE', 'PENDING', 'UNSUBSCRIBED');

-- CreateEnum
CREATE TYPE "BlogStatus" AS ENUM ('PUBLISHED', 'DRAFT', 'SCHEDULED');

-- CreateEnum
CREATE TYPE "EndorsementStatus" AS ENUM ('APPROVED', 'PENDING', 'REJECTED');
